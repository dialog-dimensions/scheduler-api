...
public class PauseAutoProcessCommand : IGptCommand
{
    private readonly IAutoScheduleProcessJobServices _jobServices;
    private readonly IQueryService _queryService;

    public PauseAutoProcessCommand(IAutoScheduleProcessJobServices jobServices, IQueryService queryService)
    {
    ...
    public async Task<IGptResponse> Execute(Dictionary<string, object> parameters)
    {
        ...
        return await _jobServices.StopProcess(process.Id);
    }
}
